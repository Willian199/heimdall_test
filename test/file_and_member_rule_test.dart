  ...
  group('File and member rules', () {
    ...
    test('checks file source and URI rules from imported content', () {
      ...
      final importByListPredicates = Heimdall.files()
          .that()
          .haveNameAny(['missing.dart', 'user_repository.dart'])
          .and()
          .haveNameEndingWithAny(['repository.dart', 'service.dart'])
          .and()
          .haveNameStartingWithNone(['generated'])
          .and()
          .haveNameMatchingAny([RegExp('repository')])
          .and()
          .resideInAnyPath(['missing', 'lib/src/data/**'])
          .and()
          .resideOutsideOfAnyPath(['lib/src/domain/**'])
          .should()
          .importUri('../domain/user.dart')
          .check(project);
      ...
      final noExactImports = Heimdall.files()
          ...
          .resideInPath('lib/src/data/user_repository.dart')
          .should()
          .importNoneUris(['missing.dart', 'forbidden.dart'])
          .check(project);
    ...
    test('checks export URI rules without treating exports as imports', () {
      ...
      final exportCombinations = Heimdall.files()
          ...
          .and()
          .exportNoneUrisMatching([RegExp('forbidden')])
          .and()
          .exportAnyUri(['missing.dart', 'domain/user.dart'])
          .and()
          .exportNoneUris(['forbidden.dart'])
          .check(project);
    ...
    test('checks member rules', () {
      ...
      final methodCombinations = Heimdall.methods()
          ...
          .haveName('findName')
          .should()
          .beAnnotatedWithAny(['Deprecated', 'Tracked'])
          .and()
          ...
          .and()
          .haveRequiredParameterAll(['prefix'])
          .and()
          .haveRequiredParameterAny(['missing', 'prefix'])
          .check(project);
      final methodPredicateCombinations = Heimdall.methods()
          .that()
          .haveNameAny(['missing', 'findName'])
          .and()
          .haveNameEndingWithAny(['Name'])
          .and()
          .haveNameStartingWithNone(['_'])
          .and()
          .haveNameMatchingAny([RegExp('find')])
          .and()
          .areAnnotatedWithAny(['Deprecated', 'Tracked'])
          .and()
          .haveReturnTypeAny(['String'])
          .should()
          .accessField('name')
          .check(project);
      ...
      final constructorCombinations = Heimdall.constructors()
          ...
          .and()
          .haveRequiredParameterNone(['missing'])
          .check(project);
      ...
      final cubitConstructorParameters = Heimdall.constructors()
          ...
          .and()
          .receiveParameterTypeNameEndingWithAny(['Missing', 'Cubit'])
          .and()
          .receiveParameterTypeNameEndingWithAll(['Cubit'])
          .and()
          .receiveParameterTypeNameStartingWithAny(['Missing', 'Child'])
          .and()
          .receiveParameterTypeNameStartingWithAll(['Child', 'View', 'Parent'])
          .and()
          .receiveParameterTypeNameMatching(RegExp(r'Cubit$'))
          .and()
          .receiveParameterTypeNameMatchingAny([RegExp('Missing'), RegExp(r'Cubit$')])
          .and()
          .receiveParameterTypeNameMatchingAll([RegExp('Child'), RegExp('Parent')])
          .and()
          .receiveParameterTypeNameStartingWithNone(['Missing'])
          .check(project);
      final cubitAssignableConstructorParameters = Heimdall.constructors()
          ...
          .and()
          .receiveParameterAssignableToAny(['Missing', 'Cubit'])
          .and()
          .receiveParameterAssignableToAll(['Cubit'])
          .and()
          .receiveParameterAssignableToNone(['Missing'])
          .check(project);
      ...
      final cubitFields = Heimdall.fields()
          ...
          .and()
          .haveDeclaredTypeNameAny(['ChildCubit', 'ViewCubit'])
          .and()
          .haveDeclaredTypeNameEndingWith('Cubit')
          .and()
          .haveDeclaredTypeNameStartingWithAny(['Child', 'View'])
          .and()
          .haveDeclaredTypeNameMatchingAny([RegExp(r'Cubit$')])
          .should()
          .beFinal()
          .check(project);
      final assignableCubitFields = Heimdall.fields()
          .that()
          .haveDeclaredTypeAssignableTo('Cubit')
          .and()
          .haveDeclaredTypeAssignableToAny(['Missing', 'Cubit'])
          .and()
          .haveDeclaredTypeAssignableToAll(['Cubit'])
          .and()
          .haveDeclaredTypeAssignableToNone(['Missing'])
          .should()
          .beFinal()
          .check(project);
      ...
      final externalFields = Heimdall.fields()
          ...
          .should()
          .haveDeclaredTypeAssignableTo('ExternalWidget')
          .check(project);
      final objectFields = Heimdall.fields().that().haveName('childCubit').should().haveDeclaredTypeAssignableTo('Object').check(project);
