  ...
  group('Class rules', () {
    ...
    test('selects and checks classes by member counts', () {
      ...
      final smallClasses = Heimdall.classes()
          ...
          .haveTypeName('SuperBase')
          .and()
          .noHaveMoreThanFields(1)
          .and()
          .noHaveMoreThanConstructors(0)
          .and()
          .noHaveMoreThanConstructorParameters(0)
          .and()
          .noHaveMoreThanMethodParameters(1)
          .should()
          .noHaveFieldCount(2)
          .and()
          .noHaveMethodCount(2)
          .and()
          .noHaveConstructorCount(1)
          .and()
          .noHaveCodeUnitCount(2)
          .and()
          .noHaveConstructorParameterCount(1)
          .and()
          .noHaveMethodParameterCount(2)
          .check(project);
    ...
    test('selects classes by raw type and identifier references', () {
      ...
      final autoCancelingServices = Heimdall.classes()
          ...
          .and()
          .noReferenceIdentifier('CancelToken')
          .should()
          .mixin('DioAutoCancel')
          .check(project);
    ...
    test('raw identifier references ignore declaration names', () {
      ...
      final result = Heimdall.classes()
          ...
          .haveTypeName('PlainServiceImpl')
          .and()
          .noReferenceIdentifier('PlainServiceImpl')
          .should()
          .bePublic()
          .check(project);
    ...
    test('only dependency any and none variants evaluate each target dependency', () {
      ...
      final anyCondition = Heimdall.classes()
          ...
          .should()
          .onlyDependOnAnyClassesThat([domainTarget, dataTarget])
          .check(project);
      ...
      final noneCondition = Heimdall.classes()
          ...
          .haveTypeName('MixedConsumer')
          .should()
          .onlyDependOnNoClassesThat([domainTarget, forbiddenTarget])
          .check(project);
    ...
    test('checks list-based class condition variants', () {
      ...
      final annotated = Heimdall.classes()
          ...
          .should()
          .beAnnotatedWithAny(['Deprecated', 'Entity'])
          .and()
          .beAnnotatedWithNone(['Deprecated'])
          .and()
          .haveTypeNameEndingWithAny(['Aggregate', 'Repository'])
          .and()
      ...
      final composite = Heimdall.classes()
          ...
          .should()
          .implementAny(['MissingGateway', 'Gateway'])
          .and()
          .extendAny(['Cubit', 'BaseRepository'])
          .and()
          .beAssignableToAny(['Cubit', 'BaseRepository'])
          .check(project);
    ...
    test('checks classes that use a mixin', () {
      ...
      final result = Heimdall.classes().that().mixin('Auditable').should().haveTypeNameEndingWith('Repository').check(project);
    ...
    test('checks transitive class relationships and typedef aliases', () {
      ...
      final transitiveExtendsPredicate = Heimdall.classes()
          ...
          .extend('GrandParent')
          .should()
          .haveTypeNameEndingWithAny(['Parent', 'Child'])
          .check(project);
      ...
      final mixinConditions = Heimdall.classes()
          ...
          .and()
          .mixinAll(['SharedBehaviorAlias', 'ExtraBehavior'])
          .and()
          .mixinAny(['MissingBehavior', 'ExtraBehavior'])
          .and()
          .mixinNone(['MissingBehavior'])
          .and()
          .mixinTypeNameEndingWith('Behavior')
          .and()
          .mixinTypeNameEndingWithAll(['Behavior', 'ExtraBehavior'])
          .and()
          .mixinTypeNameEndingWithAny(['MissingBehavior', 'ExtraBehavior'])
          .and()
          .mixinTypeNameEndingWithNone(['MissingBehavior'])
          .check(project);
    ...
    test('checks member rules for super method and field access', () {
      ...
      final ownerMixinSuffix = Heimdall.methods()
          .that()
          .areDeclaredInClassesThatHaveMixinTypeNameEndingWith('Behavior')
          .and()
          .haveName('auditChild')
          .should()
          .bePublic()
    ...
    test('checks list-based class predicates', () {
      ...
      final composite = Heimdall.classes()
          .that()
          .haveTypeNameAny(['Missing', 'CompositeRepository'])
          .and()
          .haveTypeNameNone(['LegacyRepository', 'InternalRepository'])
          .and()
          .haveTypeNameEndingWithAny(['Repository'])
          .and()
          .haveTypeNameStartingWithNone(['_'])
          .and()
          .haveTypeNameMatchingAny([RegExp('Composite')])
          .and()
          .resideInAnyPath(['missing', '**domain/**'])
          .and()
          .extendAny(['MissingBase', 'BaseRepository'])
          .and()
          .extendNone(['LegacyBase', 'InternalBase'])
          .and()
          .mixinAll(['AdvancedAuditable'])
          .and()
          .implementAll(['Gateway'])
          .and()
          .areAssignableToAll(['BaseRepository', 'Gateway'])
          .and()
          .areAssignableToNone(['MissingType'])
          .should()
          .haveTypeNameNone(['LegacyRepository', 'InternalRepository'])
          .and()
          .extendNone(['LegacyBase', 'InternalBase'])
      ...
      final annotated = Heimdall.classes()
          .that()
          .areAnnotatedWithAny(['Deprecated', 'Entity'])
          .and()
          .areAnnotatedWithNone(['Deprecated'])
          .should()
